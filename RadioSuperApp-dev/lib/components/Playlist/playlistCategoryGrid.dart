...
import 'package:radio_super_app/components/Playlist/playlistCategoryButton.dart';
...
class PlaylistCategoryGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilderWidget<GetPlaylistsCategoryGridResponse>(
      future: PlaylistService().fetchCategories(), // This will call your API to get categories
      onSuccess: (data) {
